  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        "group/calendar bg-background p-3 [--cell-size:--spacing(9)] md:[--cell-size:--spacing(11)] rounded-md border border-input shadow-lg z-50",
      ...
      classNames={{
        ...
        day_outside: cn("text-muted-foreground/70 aria-selected:text-muted-foreground"),
        day_disabled: cn(
