...
export function ActionBar({ table, onRunSelected, onRunAll, onClearSelection, filename = "text-campaigns" }: Props) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Button variant="outline" size="sm" type="button" onClick={onClearSelection}>
        Clear
      </Button>
      <DropdownMenu>
