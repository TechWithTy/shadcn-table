...
// import { DataTableColumnHeader } fro../../../../components/data-table/data-table-column-headerder";
// import { Checkbox } fro../../../../components/ui/checkboxbox";
// import { Badge } fro../../../../components/ui/badgedge";
// import { Button } fro../../../../components/ui/buttonton";
// import {
// 	Popover,
// 	PopoverContent,
// 	PopoverTrigger,
// } fro../../../../components/ui/popoverver";
// import { Input } fro../../../../components/ui/inputput";
// import { Pause, Play, Square, ThumbsDown, ThumbsUp } from "lucide-react";
// import { stopRowClick, withStopPropagation } fro../../../../utils/eventsnts";
// import type { CallCampaign } fro../../../../../../../types/_dashboard/campaignign";
// import type { CheckedState } from "@radix-ui/react-checkbox";

// // Local strong types used by this Social example to avoid `any`.
...
// 				const meta = ((table.options as unknown as { meta?: unknown })?.meta ??
// 					{}) as {
...
// 			cell: ({ row }) => {
// 				const o = row.original as SocialRow;
...
// 			cell: ({ row }) => {
// 				const original = row.original as SocialRow;
...
// 					? (o.interactionsDetails as InteractionDetail[])
// 					: [];
...
// 				);
// 				const totalReactions = li.reduce(
// 					(sum: number, it: InteractionDetail) => {
...
// 				const o = row.original as SocialRow;
// 				if (o.platform !== "facebook") return <span>-</span>;
// 				const tools: Array<{ id: number; name: string; type: string }> =
// 					o.manychatGrowthTools || [];
...
// 				const o = row.original as SocialRow;
// 				if (o.platform !== "facebook") return <span>-</span>;
// 				const flows: Array<{ ns: string; name: string; folder_id?: number }> =
// 					o.manychatFlows || [];
...
// 				const delivered =
// 					o.delivered ?? (typeof o.leads === "number" ? o.leads : 0);
...
// 			),
// 			accessorFn: (row) => (row as SocialRow)?.transfer?.type ?? "-",
// 			enableColumnFilter: true,
// 			filterFn: (row, id, value) => {
// 				const v = String(row.getValue(id) ?? "");
// 				return Array.isArray(value) ? value.includes(v) : String(value) === v;
...
// 			},
// 			cell: ({ row }) => {
// 				const t = (row.original as SocialRow).transfer;
...
// 			filterFn: (row, id, value) => {
// 				const o = row.original as SocialRow;
// 				const raw = String(o.lastSentAt ?? o.startDate ?? "");
